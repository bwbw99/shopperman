//
//  DelDeliverViewController.swift
//  capstone
//
...
class DelDeliverViewController:UIViewController, CLLocationManagerDelegate{
    var id: Int = 1
    @IBOutlet weak var boxbox: UIView!
    @IBOutlet weak var deldel: UIButton!
    ...
    @IBOutlet weak var DeleeteButton: UIButton!
    ...
    @IBAction func DeleteButtonTapped(_ sender: UIButton) {
        NotificationCenter.default.post(name: NSNotification.Name("removeData"), object: id)
